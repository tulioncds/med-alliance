...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PaymentItemRel'
        db.create_table('pagseguro2_paymentitemrel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pagseguro2.Item'])),
            ('payment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pagseguro2.Payment'])),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('pagseguro2', ['PaymentItemRel'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PaymentItemRel'
        db.delete_table('pagseguro2_paymentitemrel')
