...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Payment', fields ['code']
        db.create_unique('pagseguro2_payment', ['code'])

        # Adding unique constraint on 'Notification', fields ['code']
        db.create_unique('pagseguro2_notification', ['code'])

        # Adding unique constraint on 'Transaction', fields ['code']
        db.create_unique('pagseguro2_transaction', ['code'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Transaction', fields ['code']
        db.delete_unique('pagseguro2_transaction', ['code'])

        # Removing unique constraint on 'Notification', fields ['code']
        db.delete_unique('pagseguro2_notification', ['code'])

        # Removing unique constraint on 'Payment', fields ['code']
        db.delete_unique('pagseguro2_payment', ['code'])
