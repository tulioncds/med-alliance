...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Notification.received_on'
        db.alter_column('pagseguro2_notification', 'received_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Changing field 'Notification.received_on'
        db.alter_column('pagseguro2_notification', 'received_on', self.gf('django.db.models.fields.DateTimeField')())
