...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ErrorNotification'
        db.create_table('pagseguro2_errornotification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.IntegerField')()),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('notification', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pagseguro2.Notification'])),
        ))
        db.send_create_signal('pagseguro2', ['ErrorNotification'])

        # Adding model 'ErrorPayment'
        db.create_table('pagseguro2_errorpayment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.IntegerField')()),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('payment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pagseguro2.Payment'])),
        ))
        db.send_create_signal('pagseguro2', ['ErrorPayment'])


    def backwards(self, orm):
        
        # Deleting model 'ErrorNotification'
        db.delete_table('pagseguro2_errornotification')

        # Deleting model 'ErrorPayment'
        db.delete_table('pagseguro2_errorpayment')
    ...
    models = {
        ...
        'pagseguro2.errornotification': {
            'Meta': {'object_name': 'ErrorNotification'},
            'code': ('django.db.models.fields.IntegerField', [], {}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notification': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pagseguro2.Notification']"})
        },
        'pagseguro2.errorpayment': {
            'Meta': {'object_name': 'ErrorPayment'},
            'code': ('django.db.models.fields.IntegerField', [], {}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'pagseguro2.payment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'items': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['pagseguro2.Item']", 'through': "orm['pagseguro2.PaymentItemRel']", 'symmetrical': 'False'}),
        ...
        'pagseguro2.paymentitemrel': {
            'Meta': {'object_name': 'PaymentItemRel'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pagseguro2.Item']"}),
            'payment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pagseguro2.Payment']"}),
