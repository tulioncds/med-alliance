    ...
    $.fn.formset = function(opts)
    {
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            insertDeleteLink = function(row) {
                ...
                $('a.' + options.deleteCssClass).live('click', function() {
                    var row = $(this).closest('.' + options.formCssClass),
        ...
        $$.each(function(i) {
		    ...
		    row.children('input:checkbox[id $= "-DELETE"]').remove();                
            if (del.length) {
        ...
        if ($$.length) {
            ...
            if (options.formTemplate) {
                ...
                template.attr('class', $('.' + options.formCssClass + ':last').attr('class'))
